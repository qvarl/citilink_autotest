...
public class CorporatePage {
    ...
    @Step("Выбрать город {city} из списка основных городов")
    ...
    @Step("Проверить, что текущим городом выбран {city}")
    ...
    @Step("Кликнуть по кнопке 'Подписаться'")
    ...
    @Step("Проверяем текст скачанного файла")
